            ...
            <div class="order">
                ...
                <form action="{{ route('admin.kategori.update', $kategori->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="kategori" id="kategori" class="w-full px-4 py-2 border border-gray-300 rounded-lg" value="{{ old('kategori', $kategori->kategori) }}" required>
                        @error('kategori')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
        
                    <button type="submit" class="px-6 py-2 bg-blue-500 text-white rounded-lg">Simpan Perubahan</button>
