    ...
    <main>
        <div class="head-title">
            <div class="left">
                ...
                <ul class="breadcrumb">
                    <li>
                        <a class="active" href="#">Dashbord</a>
                    </li>
                </ul>
            </div>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @elseif($item->status == 1) status-diterima
                            @elseif($item->status == 2) status-ditolak
                            @elseif($item->status == 3) status-dikembalikan
                            @endif">
                                @if($item->status == 0)
                                    pending
                            ...
                            <td>
                                <a class="status pending" href="{{ route ('admin.pinjam.edit', $item->id) }}"> Edit
                                </a>
                            </td>
                        </tr>
                        @endforeach
